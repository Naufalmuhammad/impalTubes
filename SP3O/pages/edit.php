...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE produk SET idPrd='$Id_Produk',namaproduk='$nmPrd',quantity='$qtyPrd',harga='$pricePrd',spessingkat='$spes1Prdt',speslengkap='$spes2Prd' WHERE Id_Produk=$idPrd ");
...
<body>
    ...
    <form name="update_produk" method="post" action="edit.php">
        <table border="0">
            <tr> 
                <td>Id Produk</td>
                <td><input type="text" name="Id_Produk" value=<?php echo $idPrd;?>></td>
            </tr>
            <tr> 
                <td>Nama Produk</td>
